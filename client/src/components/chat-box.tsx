      ...
      >
          <div className="flex justify-center">
              <ProfessorAvatar
                ...
                onClick={() => setIsThreadSwitcherOpen(true)}
          ...
          <ThreadSwitcher
            ...
            onOpenChange={setIsThreadSwitcherOpen}
            threads={threads}
                        ...
                        <motion.div
                          ...
                          className={cn(
                            ...
                            msg.role === 'user'
                              ...
                              : 'bg-muted text-muted-foreground self-start ml-2 mr-12 rounded-bl-sm'
                          )}
                        >
                            <div
                              className={cn(
                                ...
                                msg.role === 'user'
                                  ...
                                  : 'left-0 transform translate-y-1/2 bg-muted clip-triangle-left'
                              )}
                            />
